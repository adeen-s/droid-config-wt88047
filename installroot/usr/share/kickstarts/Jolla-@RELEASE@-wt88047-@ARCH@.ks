# DisplayName: Jolla wt88047/@ARCH@ (release) 1
...
repo --name=adaptation0-wt88047-@RELEASE@ --baseurl=https://store-repository.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-wingtech-wt88047/@ARCH@/
...
%packages
@Jolla Configuration wt88047
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/wt88047
